...
describe ContactsController do
  ...
  describe 'GET #index' do
    ...
    context 'wihout params[:letter]' do
  ...
  describe 'POST #create' do
    ...
    context 'with valid attributes' do
      ...
      it 'redirects to contacts#show' do
        ...
        expect(response).to redirect_to assigns[:contact]
      end
    end
  ...
  describe 'PATCH #update' do
    before :each do
      @contact = create(:contact, firstname: 'Shinji', lastname: 'Yamada')
    end
    ...
    context 'with valid attributes' do
      ...
      it "changes @contact's attributes" do
        patch :update, id: @contact, contact: attributes_for(:contact, firstname: 'Larry', lastname: 'Yamada')
        @contact.reload
        expect(@contact.name).to eq 'Larry Yamada'
      end
  ...
  describe 'CSV output' do
    ...
    it "returns content" do
      create(:contact, firstname: 'Taro', lastname: 'YAMADA', email: 'taro.y@example.com')
      get :index, format: :csv
      expect(response.body).to have_content 'Taro','YAMADA','taro.y@example.com'
    end
  end
